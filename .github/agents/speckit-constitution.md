...
ai_model:
  ...
  settings:
    ...
    thinkingLevel: HIGH
  rationale: |
    Gemini 3 Pro ensures semantic versioning and policy enforcement precision.
    Advanced thinking configuration for governance consistency across all principles.

...
ai_model:
  ...
  rationale: |
    Claude Opus 4.5 excels at natural language understanding (GPQA Diamond: 87%) 
    and structured document creation. Reasoning mode ensures spec quality validation 
    and ambiguity detection. Intelligence: 49, Speed: 82 t/s, Cost: $10/1M tokens.
handoffs:
...
**AI Model**: Claude Opus 4.5 (Reasoning Mode) - Optimized for natural language understanding and structured document generation.

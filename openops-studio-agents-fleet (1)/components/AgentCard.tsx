...
export const AgentCard: React.FC<AgentCardProps> = ({ agent, onView, onAddToCart }) => {
  ...
  return (
    <>
      <div 
        ...
        className="group relative bg-white dark:bg-dark-900 border border-gray-100 dark:border-dark-800 rounded-2xl overflow-hidden hover:border-brand-500 dark:hover:border-brand-500 transition-all duration-300 hover:shadow-2xl hover:shadow-gray-200/50 dark:hover:shadow-brand-900/10 cursor-pointer flex flex-col h-full"
      >
